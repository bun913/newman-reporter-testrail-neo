...
describe("Test assertions", () => {
  ...
  it("Should handle multiple mapped test cases", () => {
    const reporter = new TestrailReporter({ on: () => null })
  ...
  it("Should handle two test cases", () => {
    const reporter = new TestrailReporter({ on: () => null })
  ...
  it("Should work on tld with no path", () => {
    const reporter = new TestrailReporter({ on: () => null })
